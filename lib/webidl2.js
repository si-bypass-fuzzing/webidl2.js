...
import { CallbackConstructor } from "./productions/callback-constructor.js";
import { BodylessInterface } from "./productions/bodyless-interface.js";
...
function parseByTokens(tokeniser, options) {
  ...
  function interface_(opts) {
    ...
    return (
      ...
      BodylessInterface.parse(tokeniser) ||
  ...
  function definition() {
    ...
    return (
      CallbackConstructor.parse(tokeniser) ||
      callback() ||
      BodylessInterface.parse(tokeniser) ||
      interface_()||
      partial() ||
